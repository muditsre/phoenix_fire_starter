...
;require.register("web/static/js/event.js", function(exports, require, module) {
'use strict';
...
(function () {
    ...
    var channel = _socket2.default.channel("event:" + id, {});

    channel.on("update_quantity", function (event) {
